...
import com.wavesenterprise.network.message.MessageSpec.{PeersSpec, TransactionSpec}
...
class MetaMessageCodecSpec extends FreeSpec with Matchers with MockFactory with ScalaCheckPropertyChecks with TransactionGen {

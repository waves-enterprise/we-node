...
import org.scalatest.{DoNotDiscover, Inside, Matchers, PropSpec}
...
@DoNotDiscover
class ExchangeTransactionDiffTest extends PropSpec with ScalaCheckPropertyChecks with Matchers with TransactionGen with Inside with NoShrink {

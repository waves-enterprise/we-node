...
class LegacyContractExecutor(
  ...
  def createContainerEnvParams: List[String] =
    List(
  ...
  protected override def startContainer(
      contract: ContractInfo,
      metrics: ContractExecutionMetrics
  ): Task[String] = deferEither {
    dockerEngine.createAndStartContainer(contract, metrics, createContainerEnvParams)
  }

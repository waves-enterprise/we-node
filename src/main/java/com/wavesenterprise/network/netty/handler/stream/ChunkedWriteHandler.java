 ...
 * <p>
 * Based on <a href="https://github.com/netty/netty/blob/4.1/handler/src/main/java/io/netty/handler/stream/ChunkedWriteHandler.java">netty implementation</a>.
 * Modifications: the end of input check is performed before reading the chunk to correctly send the last chunk.
 */
public class ChunkedWriteHandler extends ChannelDuplexHandler {

    public static final int CHUNK_MAGIC = 0x87654321;

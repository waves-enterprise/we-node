...
case class ApiSettings(
    rest: RestApiSettings,
    grpc: GrpcApiSettings,
...
sealed abstract class ApiType(val value: String)
object RestApi extends ApiType("REST")
object GrpcApi extends ApiType("gRPC")

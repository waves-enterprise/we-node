...
import com.wavesenterprise.api.http.{ApiError, BaseJsonCryptoAlgo, DecryptDataRequest, DecryptDataResponse, EncryptDataRequest}
...
class CryptoApiService(wallet: Wallet, cryptoScheduler: Scheduler) extends CommonCryptoApiService(wallet) with BaseJsonCryptoAlgo {

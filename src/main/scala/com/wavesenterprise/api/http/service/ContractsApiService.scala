...
import com.wavesenterprise.state.{ByteStr, ContractBlockchain, DataEntry}
...
class ContractsApiService(blockchain: ContractBlockchain, messagesCache: ContractExecutionMessagesCache) {

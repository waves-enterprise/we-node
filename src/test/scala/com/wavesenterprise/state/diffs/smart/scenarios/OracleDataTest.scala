...
import com.wavesenterprise.lang.Global.MaxBase58Bytes
...
class OracleDataTest extends PropSpec with ScalaCheckPropertyChecks with Matchers with TransactionGen with NoShrink {
  val preconditions

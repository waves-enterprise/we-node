...
import com.wavesenterprise.lang.{Global, Testing}
...
class NotaryControlledTransferScenarioTest extends PropSpec with ScalaCheckPropertyChecks with Matchers with TransactionGen with NoShrink {

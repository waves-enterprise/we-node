...
/**
  ...
  *
  * Detailed information: https://confluence.wavesplatform.com/pages/viewpage.action?spaceKey=VO&title=Anchoring+Blockchain
  */
class AnchoringScheduler(
  ...
  private def createAnchoringTransactionOnError(ex: Throwable, blockOnHeight: BlockOnHeight): Task[Unit] = {
    ...
    ourChainDataTx.flatMap(txBroadcaster.broadcastIfNew) match {

...
trait PeerConnectionGen {
  ...
  protected def randomHandshake(): Gen[(SignedHandshakeV2, PublicKeyAccount)] = {
    for {
  ...
  protected def createHandshake(ownerKey: PrivateKeyAccount): Gen[SignedHandshakeV2] = {
    for {
    ...
    } yield SignedHandshakeV2.createAndSign(appInfo, sessionPublicKey, ownerKey)
  }

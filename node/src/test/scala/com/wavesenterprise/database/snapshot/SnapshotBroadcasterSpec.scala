...
class SnapshotBroadcasterSpec extends AnyFreeSpec with MockFactory with Matchers with PeerConnectionGen with RxSetup {
      ...
      try {
        ResourceUtils.withResource {
          new SnapshotBroadcaster(defaultSigner,
                                  ...
                                  BroadcasterTimeSpans(5.second))(consensualSnapshotScheduler) {

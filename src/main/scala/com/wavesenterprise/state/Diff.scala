...
import com.wavesenterprise.transaction.{AssetId, CreatePolicyTransaction, PolicyDataHashTransaction, Transaction, UpdatePolicyTransaction}
...
object Diff {
  ...
  def apply(height: Int,
            ...
            dataHashToSender: Map[PolicyDataHash, Address] = Map.empty): Diff =
    Diff(

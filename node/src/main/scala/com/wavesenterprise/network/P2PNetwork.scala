...
class P2PNetwork private (networkSettings: NetworkSettings, networkServer: NetworkServer, peerDatabase: PeerDatabase) extends ScorexLogging {
...
object P2PNetwork extends ScorexLogging {
  ...
  def apply(networkSettings: NetworkSettings, networkServer: NetworkServer, peerDatabase: PeerDatabase): P2PNetwork =
